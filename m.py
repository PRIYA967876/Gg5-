...
bot = telebot.TeleBot('7439277702:AAGQ9yjvcUj6iCIAMfWmmRUTV1omrTs96Oo')

# Admin user IDs
admin_id = ["1291855508","6552242136"]
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 1:
                response = "You Are On Cooldown. Please Wait 1sec Before Running The attack Command Again."
                bot.reply_to(message, response)
                return
...
def welcome_start(message):
    ...
    response = f"Welcome to Your Home, {user_name}! Feel Free to Explore.\nTry To Run This Command : /help\nWelcome To The World's Best Ddos Bot\nBy https://t.me/+a58zYz6ZW4Q1NWY1"
    bot.reply_to(message, response)
